# m68k
A over ambitious project to build a usable computer from scratch based on the Motorola 680x0 series processors. Based on bits and pieces from the interwebb, but with my own twists and turns. Some decisions made from my part:
